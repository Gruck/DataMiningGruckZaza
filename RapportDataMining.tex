...
\input{Anaylse_Axes_de_Recherche.tex}


\input{Analyse_Clustering_Hierarchique.tex}
%montrer les résultats  
   % dendrogramme
   % distance
   % conclusion sur le nb de clusters
\input{Analyse_Clustering_Partionement.tex}
% liste des attributs qui servent a partitioner
   % pourquoi
   % resultats
\input{Validation_Modele.tex}
   % cross validation
\newpage
\part{Projet - UE et ses nouveaux membres en 2007}
\input{intro_projet.tex}
